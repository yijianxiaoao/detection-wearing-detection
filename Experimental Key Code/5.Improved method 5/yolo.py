...
from nets.CSPdarknet53 import DarknetConv2D,CSPdarknet53
#from nets.CSPdarknet53_tiny import DarknetConv2D,CSPdarknet53
...
def yolo_body(input_shape, anchors_mask, num_classes, backbone="mobilenetv1", alpha=1, weight_decay=5e-4):
    ...
    #elif backbone == "CSPdarknet53_tiny":
        # ---------------------------------------------------#
        #   52,52,512；26,26,1024；13,13,2048
        # ---------------------------------------------------#
     #   feat1, feat2, feat3 = CSPdarknet53(inputs)
    ...
    P5_upsample = compose(DarknetConv2D_BN_Leaky(int(256 * alpha), (1, 1), weight_decay=weight_decay), UpSampling2D(2))(
        P5)
    ...
    P4_upsample = compose(DarknetConv2D_BN_Leaky(int(128 * alpha), (1, 1), weight_decay=weight_decay), UpSampling2D(2))(
        P4)
